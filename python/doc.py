...
class Doc:
	...
	def make_html_details(self, tree):
		...
		if 'pos' in tree.attrib:
			ET.SubElement(element_text, 'p').text = 'Position: ' + tree.get('pos')

		if 'rot' in tree.attrib:
			ET.SubElement(element_text, 'p').text = 'Rotation: ' + tree.get('rot')
